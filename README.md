...
Whats really cool is that incase iAd banners are having an error it will automatically load an AdMob banner and in case the AdMob banner is having an error it will reload an iAd banner. 
...
I did not do the same for Inter Ads because they will always preload before you can show them so there is really no point.
