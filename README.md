...
Then read your 3rd party ad network(s) of choice mediation guidlines to set up reward videos correctly. This will unclude installing their SDK and mediation adapters.
...
For permanent storage you will need to create your own "removedAdsProduct" property and save it in something like UserDefaults, or preferably iOS Keychain. Then at app launch check if your saved property is set to true and then updated the helper poperty.
...
Then create an extension conforming to the AdsDelegate protocol.
```swift
extension GameScene: SwiftyAdDelegate {
    ...
    func swifyAd(_ swiftyAd: SwiftyAd, didRewardUserWithAmount rewardAmount: Int) {
       ...
       // You can ignore this and hardcore the value if you would like but then you cannot change the value dynamically without having to update your app.
